...
public final class LocationManagerService: NSObject, ObservableObject, CLLocationManagerDelegate {
    ...
    public func startUpdating() {
        ...
        case .authorizedAlways:
            ...
            logger.log("Authorized Always - background updates set to \(allowsBackground)")
        @unknown default:
            manager.allowsBackgroundLocationUpdates = false
    ...
    public func locationManagerDidChangeAuthorization(_ manager: CLLocationManager) {
        ...
        logger.log("Authorization status changed to: \(authorization.rawValue)")
    ...
    @objc private func batteryStateDidChange() {
        logger.log("Battery state changed: \(batteryState.rawValue)")
        adaptBackgroundLocationUpdates()
    }
